...
let kristina = User(name: "Kristina", age: 27, height: 5.3, weight: 127.0, activityLevel: 5)

print("The user's name is \(kristina.name). She is \(kristina.age) years old. She weighs \(kristina.weight) lbs and stands at \(kristina.height) ft tall. Her activity level is \(kristina.activityLevel) out of 10.")
...
let userDistance = Distance(feet: 10)

print(userDistance.meters)
...
let userWorkout = RunningWorkout(distance: 4800, time: 30, elevation: 10)

print(userWorkout.averageMileTime)
...
var userSteps = Steps(steps: 9999, goal: 10000)
