...
favoriteBook = Book(title: "The City We Became", author: "N.K. Jemisin", pages: 488, price: 24.99)

print("My current favorite book is \(favoriteBook.title) by \(favoriteBook.author). It has \(favoriteBook.pages) pages and is priced at $\(favoriteBook.price) for the hardcover edition.")
